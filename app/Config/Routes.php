...
$routes->add('/spengaduan','pengaduanController::Simpan',);
...
$routes->add('/stanggapan','tanggapanController::Simpan',);
...
$routes->add('/pregister','LoginController::pregister');
$routes->get('logout','LoginContrroler::login');
/*
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------

                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    ...
                                    <div class="form-group row">
                                            <input type="nik" class="form-control form-control-user" id="exampleInputNik" placeholder="Nik">
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <input type="telp" class="form-control form-control-user" id="exampleInputTelp" placeholder="Telp">
                                        </div>
